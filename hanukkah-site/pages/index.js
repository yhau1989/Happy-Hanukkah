  ...
  return (
    <div className={styles.container}>
      ...
      <div className="w-full sm:w-auto flex-none flex flex-col-reverse sm:flex-row sm:items-start space-y-3 space-y-reverse sm:space-y-0 sm:space-x-4 mt-10 mx-auto xl:mx-0 p-20">
        <div className="cursor-pointer w-full sm:w-auto sm:flex-wrap sm:text-center md:inline-flex inline-flex items-center justify-center font-medium text-indigo-700 bg-opacity-20 group-hover:bg-opacity-30 rounded-lg shadow-sm group-hover:shadow-lg py-3 px-5 border border-indigo-500 border-opacity-10 transition duration-150 transform group-hover:-translate-y-0.5">
          <svg
            width="24"
            height="24"
            fill="currentColor"
        ...
        <div onClick={() => auth.signinWithGoogle('/dashboard')}  className="cursor-pointer w-full sm:w-auto sm:flex-wrap sm:text-center md:inline-flex inline-flex  sm:items-block items-center justify-center font-medium text-indigo-700 bg-opacity-20 group-hover:bg-opacity-30 rounded-lg shadow-sm group-hover:shadow-lg py-3 px-5 border border-indigo-500 border-opacity-10 transform group-hover:-translate-y-0.5 transition-all duration-150">
          <svg
            width="24"
            height="24"
            fill="currentColor"
      ...
      <div className="text-center text-purple-100 px-10 font_Varela">
