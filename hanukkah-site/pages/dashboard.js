      ...
      return (
        <div className="dashboard">
          ...
          <p className="text-center text-purple-100 px-2 py-3 sm:px-10 font_Varela">
            {locale == "en" ? (
              <>
                Touch the central candle, recite the blessings, then light the
                candles from right to left (depending on the day, in order "one
                more candle per day"){" "}
                <Link
                  className="mx-3"
                  href="https://youtu.be/WQEqQKcEzzo"
                  legacyBehavior
                >
                  <a
                  ...
                  >
                    👉 <span className="px-1">watch video</span>
                  </a>
                </Link>
              </>
            ) : (
              <>
                Toca la candela central, recite las bendiciones, luego
                enciéndalas las candelas de derecha a izquierda (según el día,
                en orden "una candela más por día"){" "}
                <Link
                  className="mx-3"
                  href="https://youtu.be/HUbZuXYgbDk?t=113"
                  legacyBehavior
                >
                  <a
                    className="text-indigo-500 hover:text-indigo-300"
                    ...
                    rel="noopener noreferrer"
                  >
                    👉 <span className="px-1">ver video</span>
                  </a>
                </Link>
              </>
            )}
